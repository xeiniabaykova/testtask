...
public:
  ...
  */
  ...
  virtual double      DistanceToPoint        ( Point point ) const;                                            ///< Вернуть расстояние от точки до полилинии эллипса.
  ...
  bool                IsClosed               () const;                                                         ///< Вернуть замкнутость кривой.
  double              Degree                 () const;                                                         ///< Вернуть степень криовой.
