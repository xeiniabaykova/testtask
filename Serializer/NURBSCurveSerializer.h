...
public:
  /**  \brief Прочитать nurbs - кривую из потока.
      Данные читаются в следующем порядке: количество опорных точек, опорные точки (Point),
      количество весов, веса, степень кривой, замкнутость.
  ...
  */
  ...
  /**  \brief Записать nurbs - кривую в поток.
       Данные записываются в следующем порядке: количество опорных точек, опорные точки (Point),
